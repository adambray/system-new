...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Adam Bray"
    user-mail-address "adam.bray@gmail.com")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/adambray/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/adambray/bin" "/profile/bin" "/Users/adambray/.npm-packages/bin" "/Users/adambray/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
